...
## [3.17.0](https://github.com/osovv/reatom/compare/async-v3.16.2...async-v3.17.0) (2024-10-25)


### Features

* **async:** add initState to errorAtom ([6852b72](https://github.com/osovv/reatom/commit/6852b7291ccc4fb6acfb9ecfb48d3c2326fa78ee))
* **async:** add reset action to statusesAtom ([7803168](https://github.com/osovv/reatom/commit/78031689792d7737641fc822324dbe482c4a8fec))
* **async:** add shouldPending and swrPendingAtom ([103e30c](https://github.com/osovv/reatom/commit/103e30c7aa8bd7879da347d2653389a39221d952))
...
* **async:** deprecate reatomAsyncReaction in favor of reatomReactiveAsync ([678adf2](https://github.com/osovv/reatom/commit/678adf2b337b6a895f94e5997739274822332c4f))
...
* **async:** activate resource on pending connection ([81f19b9](https://github.com/osovv/reatom/commit/81f19b996c0a2535b2c9056dd4197f447620604f))
...
* **async:** allow empty deps for reatomResource ([47c9a2e](https://github.com/osovv/reatom/commit/47c9a2e4350522ca39af3c5c4cf848a1ad5f967a))
...
* **async:** dataAtom should be computed first ([8aab299](https://github.com/osovv/reatom/commit/8aab299916f35afc0cb89983c58eeb4ae5b237cb))
* **async:** do not cache aborted promise ([1b6fbe8](https://github.com/osovv/reatom/commit/1b6fbe83ae10a0b170996a16c272a1783d77cb39))
...
* **async:** errorAtom: AtomMut ([a1349a8](https://github.com/osovv/reatom/commit/a1349a8118366a75d4cb9bf40d6e94274a2a87f2))
...
* **async:** improve withStatusesAtom update order ([316bac5](https://github.com/osovv/reatom/commit/316bac55d18cdd24c743e3e6e6eb5645b2ebf5c6))
...
* **async:** reatomResource small mem leak ([408d916](https://github.com/osovv/reatom/commit/408d9167712cf53dc4381caee3c08f353752d990))
...
* **async:** withAbort + withRetry ([d5190ab](https://github.com/osovv/reatom/commit/d5190ab87d57e3925652e07c0741c2938b80cd39))
...
* **async:** withErrorAtom should be computed first ([0c458da](https://github.com/osovv/reatom/commit/0c458da9f1eaf6a3226ca2e57f8ba5360dc7ce9e))
* **async:** withRetry races ([0abe299](https://github.com/osovv/reatom/commit/0abe29976c319525544efd5fd659e004b76d6edf))

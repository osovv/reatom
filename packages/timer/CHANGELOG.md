...
## [3.7.0](https://github.com/osovv/reatom/compare/timer-v3.6.2...timer-v3.7.0) (2025-02-05)


### Features

* **timer:** add passed option to startTimer ([2ba31a4](https://github.com/osovv/reatom/commit/2ba31a45041ed1009d59a7628fc530dd8faa7027))
...
* **timer:** do not allow the timer mutations ([05643d8](https://github.com/osovv/reatom/commit/05643d87eb0d8e8000581adfcb20deb2d2bb4169))
* **timer:** use ctx.schedule for each iteration ([302cf99](https://github.com/osovv/reatom/commit/302cf9919036267c45fff4c2c865eac89248944f))
